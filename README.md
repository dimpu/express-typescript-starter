...
[![Dependency Status](https://david-dm.org/dimpu/express-typescript-starter.svg)](https://david-dm.org/dimpu/express-typescript-starter) [![Build Status](https://travis-ci.org/dimpu/express-typescript-starter.svg?branch=master)](https://travis-ci.org/dimpu/express-typescript-starter) 
...
```
git clone --depth=1 https://github.com/dimpu/express-typescript-starter.git <project_name>
```
...
| ------------------------- | ------------------------------------------------------------------------------------------------- |
| `start`                   | Does the same as 'npm run watch'. Can be invoked with `npm start`                    
| `watch`                   | Runs nodemon with ts-node |
| `test`                    | Runs tests using Jest test runner |                                                  
| `copy.public`             | Calls script that copies JS libs, fonts, and images to dist directory |
...
#### Using `dts-gen`
Unless you are familiar with `.d.ts` files, I strongly recommend trying to use the tool [dts-gen](https://github.com/dimpu/dts-gen) first.
The [README](https://github.com/dimpu/dts-gen#dts-gen-a-typescript-definition-file-generator) does a great job explaining how to use the tool, and for most cases, you'll get an excellent scaffold of a `.d.ts` file to start with.
...
# Microsoft Starter Project
A majority of this quick start's content was inspired or adapted from Microsofts's excellent [Hackathon Starter project](https://github.com/Microsoft/TypeScript-Node-Starter).
